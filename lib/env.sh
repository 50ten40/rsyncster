...
STAGINGDIR="$DOCROOTDIR/$STAGINGSTRING"
LIVEDIR="$DOCROOTDIR/$LIVESTRING"
...
export DEBUG SCHEME PREFIX LOADBALANCER CHANGESSTRING STAGINGSTRING LIVEDIR DOCROOTDIR STAGINGSTRING LIVEDIR WORKINGDIR DOMAINSFILE RSYNCSTERSCRIPT DRUPALCACHE APPSERVERS APPSERVERSSHORTNAME APPSERVERSMASTER LIBDIR LOGDIR WEBUSER status exclusions waittime stagingservers webservers
